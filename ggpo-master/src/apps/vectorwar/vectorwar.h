...
void VectorWar_Init(HWND hwnd, int num_players, GGPOPlayer *players, int num_spectators);
void VectorWar_InitSpectator(HWND hwnd, int num_players, char *host_ip, unsigned short host_port);
