...
rem cmake -G "Visual Studio 16 2019" -A x64 -B build -DBUILD_SHARED_LIBS=%GGPO_SHARED_LIB%
cmake -G "Visual Studio 16 2019" -A win32 -B build -DBUILD_SHARED_LIBS=%GGPO_SHARED_LIB%
